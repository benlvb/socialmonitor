...
- **playstore public** (`app_public`, google-play-scraper — D25): `public/<lang>/<target>` per
  app target × `limits.playstore_langs`. `reviews({appId, lang, sort: NEWEST, num: 100, paginate})`
